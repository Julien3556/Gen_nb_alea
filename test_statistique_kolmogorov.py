...
def BBS():
    ...
    test = test_kolmogorov_smirnov(tous_les_octets)
    affichage_ks(test,longueur_totale)
...
def Gen_Systeme():
     ...
     test = test_kolmogorov_smirnov(octets)
     affichage_ks(test,1000) 
...
def XOR_NRGB():
    ...
    test = test_kolmogorov_smirnov(resultat)
    affichage_ks(test,len(resultat))
